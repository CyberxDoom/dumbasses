...
log.info("------------------------------")
log.info("[KAZUKO] Kazuko is starting. | Dc bot project. | Licensed under GPLv3.")
log.info("[KAZUKO] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[KAZUKO] Project maintained by: github.com/aldrinsai6 (t.me/bRoThEr_Of_ViLlAiN)")
log.info("------------------------")
